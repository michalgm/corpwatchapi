...
#-----------------------------------   
# This is the guts of the subsidary parser, it processes the Exhibit 21 filings to try to pull out subsidary names, locations, and hierarchy using a buch of crazy regexs and stopwords
#-----------------------------------
